...
describe("filter", () => {
  it("rejects values in both directions, data-first and data-last", () => {
...
describe("lengthPrefixed / countPrefixed", () => {
  ...
  it("derives the count from the items when printing, data-first and data-last", () => {
...
describe("merge", () => {
  ...
  it("flattens its parts, nests, and sees through filter", () => {
    const named = G.merge(
  ...
  it("reports print failures by flat field path", () => {
  ...
  it("rejects duplicate fields and parts whose fields it cannot know", () => {
